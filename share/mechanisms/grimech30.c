...
void Pele_binary_diffusion_coefficients(
    const dfloat wbar,
    dfloat Xloc[],
    dfloat Yloc[],
    dfloat logT[3],
    ...
    dfloat trans_wt[/*NUM_SPECIES*/] // What is this ?
) {
...
void fg_rho_Di(dfloat _p, dfloat T, const dfloat mass_fractions[], /*->*/ dfloat* rho_Di) {
    dfloat mean_rcp_molar_mass = 0.;
    for (int i = 0; i < NUM_SPECIES; ++i) {
    ...
    dfloat density = total_concentration * mean_molar_mass;
    dfloat trans_wt[/*NUM_SPECIES*/]; // What is this ?
    dfloat wbar = mean_molar_mass;
    dfloat logT[3] = {log(T), pow(log(T), 2), pow(log(T), 3)};
    dfloat Tloc = T;
    Pele_binary_diffusion_coefficients(
        wbar,
        /*Xloc:*/mole_fractions,
        /*Yloc:*/mass_fractions,
        logT,
        ...
        /*trans_fitdbin:*/binary_diffusion_coefficients,
