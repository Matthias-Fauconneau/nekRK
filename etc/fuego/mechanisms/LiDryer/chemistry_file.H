...
void fg_exp_Gibbs_RT(const dfloat log_T, const dfloat T, const dfloat T_2, const dfloat T_3, const dfloat T_4, const dfloat rcp_T, dfloat* species) {
    if (T < 1000.0) {
        species[0] = exp2(-1.46075884e+03 * rcp_T +9.51056079e+00 -4.75818759e+00 * log_T -5.95071434e-04 * T +1.95798130e-07 * T_2 +1.13918018e-11 * T_3 -2.98267984e-14 * T_4);
        species[1] = exp2(-1.45026778e+03 * rcp_T -4.07099858e+00 -4.63528741e+00 * log_T -8.13309483e-04 * T +1.38406162e-07 * T_2 -1.57960347e-10 * T_3 +6.32517463e-14 * T_4);
        species[2] = exp2(-4.35810953e+04 * rcp_T +1.14926478e+00 -4.88618086e+00 * log_T -2.50666998e-03 * T +1.52798148e-06 * T_2 -8.37794803e-10 * T_3 +1.80812138e-13 * T_4);
        species[3] = exp2(+3.67477900e+04 * rcp_T +4.27054699e+00 -3.60673760e+00 * log_T -0.00000000e+00 * T -0.00000000e+00 * T_2 -0.00000000e+00 * T_3 -0.00000000e+00 * T_4);
        species[4] = exp2(+4.20511622e+04 * rcp_T -2.53426696e-02 -4.25079819e+00 * log_T +1.18168734e-03 * T -5.82135071e-07 * T_2 +1.92701160e-10 * T_3 -2.80654417e-14 * T_4);
        species[5] = exp2(+4.82770359e+03 * rcp_T +6.94764215e+00 -5.95155795e+00 * log_T +2.32666992e-03 * T -1.56956730e-06 * T_2 +6.97126646e-10 * T_3 -1.48768822e-13 * T_4);
        species[6] = exp2(+4.25318097e+02 * rcp_T +8.44172171e-01 -6.20618266e+00 * log_T +3.42576630e-03 * T -5.08749313e-06 * T_2 +2.91861888e-09 * T_3 -6.70294239e-13 * T_4);
        species[7] = exp2(-2.54825339e+04 * rcp_T -4.90027175e+00 -4.88893809e+00 * log_T -4.73869475e-03 * T +3.57070047e-08 * T_2 +5.56135557e-10 * T_3 -1.78282104e-13 * T_4);
        species[8] = exp2(-1.47284737e+03 * rcp_T -9.40197145e-01 -4.75898495e+00 * log_T -1.01583043e-03 * T +9.52953454e-07 * T_2 -6.78248809e-10 * T_3 +1.76359009e-13 * T_4);
    } else {
        species[0] = exp2(-1.20469941e+03 * rcp_T +6.27072238e+00 -4.31571166e+00 * log_T -5.04989727e-04 * T +1.35464945e-08 * T_2 +1.10986267e-12 * T_3 -1.14171408e-16 * T_4);
        species[1] = exp2(-1.78018495e+03 * rcp_T +7.33484337e-01 -5.33447772e+00 * log_T -4.42560906e-04 * T +3.02687516e-08 * T_2 -2.13432482e-12 * T_3 +8.19764793e-17 * T_4);
        species[2] = exp2(-4.31354406e+04 * rcp_T -6.04586056e+00 -3.85509122e+00 * log_T -2.20464930e-03 * T +2.09918383e-07 * T_2 -1.44389295e-11 * T_3 +4.61057770e-16 * T_4);
        species[3] = exp2(+3.67477900e+04 * rcp_T +4.27054704e+00 -3.60673760e+00 * log_T -0.00000000e+00 * T -0.00000000e+00 * T_2 -0.00000000e+00 * T_3 -0.00000000e+00 * T_4);
        species[4] = exp2(+4.21711341e+04 * rcp_T -3.43108724e+00 -3.66741687e+00 * log_T +1.98735708e-05 * T +7.46066501e-10 * T_2 -5.47150200e-13 * T_3 +3.15088312e-17 * T_4);
        species[5] = exp2(+5.31435293e+03 * rcp_T -4.09279869e+00 -4.13293012e+00 * log_T -7.62106887e-04 * T +6.22962350e-08 * T_2 -3.66947889e-12 * T_3 +9.60805149e-17 * T_4);
        species[6] = exp2(+1.61375125e+02 * rcp_T +3.34862143e-01 -5.79561024e+00 * log_T -1.61568870e-03 * T +1.52362578e-07 * T_2 -1.37352226e-11 * T_3 +7.78395542e-16 * T_4);
        species[7] = exp2(-2.59785532e+04 * rcp_T +5.87469733e+00 -6.59768514e+00 * log_T -3.12786123e-03 * T +3.54587708e-07 * T_2 -2.82395961e-11 * T_3 +1.03271975e-15 * T_4);
        species[8] = exp2(-1.33131567e+03 * rcp_T -4.40582907e+00 -4.22224901e+00 * log_T -1.07334852e-03 * T +1.36689608e-07 * T_2 -1.21391246e-11 * T_3 +4.87151300e-16 * T_4);
    }
}
