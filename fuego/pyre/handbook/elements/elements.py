...
Hydrogen     = Element(  1, "H",  "Hydrogen",       1.0079699754714966)
Helium       = Element(  2, "He", "Helium",         4.0026001930236816)
Lithium      = Element(  3, "Li", "Lithium",        6.9390001296997070)
Beryllium    = Element(  4, "Be", "Beryllium",      9.0122003555297852)
Boron        = Element(  5, "B",  "Boron",         10.810999870300293)
Carbon       = Element(  6, "C",  "Carbon",        12.011150360107422)
Nitrogen     = Element(  7, "N",  "Nitrogen",      14.006699562072754)
Oxygen       = Element(  8, "O",  "Oxygen",        15.999400138854980)
Fluorine     = Element(  9, "F",  "Fluorine",      18.998399734497070)
Neon         = Element( 10, "Ne", "Neon",          20.183000564575195)
Sodium       = Element( 11, "Na", "Sodium",        22.989799499511719)
Magnesium    = Element( 12, "Mg", "Magnesium",     24.312000274658203)
Aluminum     = Element( 13, "Al", "Aluminum",      26.981500625610352)
Silicon      = Element( 14, "Si", "Silicon",       28.086000442504883)
Phosphorus   = Element( 15, "P",  "Phosphorus",    30.973800659179688)
Sulfur       = Element( 16, "S",  "Sulfur",        32.063999176025391)
Chlorine     = Element( 17, "Cl", "Chlorine",      35.452999114990234)
Argon        = Element( 18, "Ar", "Argon",         39.948001861572266)
Potassium    = Element( 19, "K",  "Potassium",     39.102001190185547)
Calcium      = Element( 20, "Ca", "Calcium",       40.080001831054688)
...
Bromine      = Element( 35, "Br", "Bromine",       79.900901794433594)
Krypton      = Element( 36, "Kr", "Krypton",       83.800003051757812)
...
# version
__id__ = "$Id: elements.py,v 1.1.1.1 2006-11-27 00:09:59 aivazis Exp $"
